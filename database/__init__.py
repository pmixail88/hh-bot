...
from .repository import (
    ...
    GeneratedResumeRepository,  # если есть
    CoverLetterRepository,      # если есть
    StatisticsRepository        # <-- ЭТОЙ СТРОКИ МОЖЕТ НЕ БЫТЬ!
)
...
__all__ = [
    ...
    'UserVacancyRepository', 'LLMSettingsRepository', 'GeneratedResumeRepository', 'CoverLetterRepository',
